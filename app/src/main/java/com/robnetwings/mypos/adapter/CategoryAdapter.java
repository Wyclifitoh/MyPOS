package com.robnetwings.mypos.adapter;
...
import com.robnetwings.mypos.settings.categories.EditCategoryActivity;
                ...
                builder.setMessage(R.string.want_to_delete_category)
                        ...
                        .setPositiveButton(R.string.yes, new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                databaseAccess.open();
                                boolean deleteCategory = databaseAccess.deleteCategory(category_id);
